...
import com.blissos.updater.R;

import com.blissos.updater.controller.UpdaterController;
import com.blissos.updater.controller.UpdaterService;
import com.blissos.updater.download.DownloadClient;
import com.blissos.updater.misc.BuildInfoUtils;
import com.blissos.updater.misc.Constants;
import com.blissos.updater.misc.StringGenerator;
import com.blissos.updater.misc.Utils;
import com.blissos.updater.model.UpdateInfo;
    ...
    private void downloadUpdatesList(final boolean manualRefresh) {
        ...
        DownloadClient.DownloadCallback callback = new DownloadClient.DownloadCallback() {
            ...
            public void onFailure(final boolean cancelled) {
                ...
                runOnUiThread(() -> {
                    if (!cancelled) {
                        showSnackbar(R.string.snack_updates_server_failed, Snackbar.LENGTH_LONG);
                    }
        ...
        try {
            ...
            showSnackbar(R.string.snack_download_client_failed, Snackbar.LENGTH_LONG);
            return;
        }

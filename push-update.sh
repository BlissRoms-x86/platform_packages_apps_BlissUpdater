...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have Bliss-VERSION-CODENAME-TYPE-DATE.* as format"
...
# Assume Bliss-VERSION-CODENAME-TYPE-DATE.zip
...
adb shell "killall com.blissos.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.blissos.updater/databases/updates.db" \
